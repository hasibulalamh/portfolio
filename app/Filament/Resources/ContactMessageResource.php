            ...
            ->schema([
                ...
                Forms\Components\Section::make('Availability Status')
                    ->schema([
                        ...
                        Forms\Components\Textarea::make('availability_message')
                            ->rows(2)
                            ->maxLength(255)
                            ->placeholder('e.g., Currently available for new projects starting March 2026'),
                    ])
                    ->columns(1),
                ...
                Forms\Components\Section::make('Display Settings')
                    ->schema([
                        Forms\Components\Toggle::make('show_form')
                            ...
                            ->default(true)
                            ->helperText('Display the contact form on frontend'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('show_form')
                    ->boolean()
                    ->label('Form'),
